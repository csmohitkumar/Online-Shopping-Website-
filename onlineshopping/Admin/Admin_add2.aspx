                ...
                <div class="content">
                    ...
                    <table align="left" border="0" class="tablewidth">
                        <tr align="left">
                            ...
                            <td class="style16">
                                <asp:TextBox ID="txtCompanyName" runat="server" Width="228px" OnTextChanged="txtCompanyName_TextChanged" 
                                    ></asp:TextBox>
                            </td>
                            <td class="style17">
                                </td>
                   ...
                   <div class="content">
                       <table>
                           <tr align="center">
                               ...
                               <td class="style6">
                                  <asp:TextBox ID="txtFileUpload" runat="server" Visible="false"></asp:TextBox><asp:FileUpload ID="uploadImage" runat="server" />
                               </td>
